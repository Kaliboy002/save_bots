...
def start(message):
    ...
    bot.send_message(message.chat.id, "<b>Pizza save</b> - бот для загрузки видео с Instagram*, TikTok и "
                                      "Pinterest\n"
                                      "<i>*Признана экстремистской организацией и запрещена на территории РФ</i>"
                                      "\n\n@pizdza_bot - прародитель бота"
                                      "\nПо всем вопросам: @kshi_rar"
                                      "\n\nПоддержать бота: https://yoomoney.ru/to/4100118148718990"
